...
//}
void boomUp(int voltage, char buffer[]){
	//	char type ="A";
	//	uint8_t pin = 9;
	int ebuNum = 1;
...
void boomDown(int voltage, char buffer[]){
	//	char type ="A";
	//	uint8_t pin = 10;
	int ebuNum = 1;
	//enQueuePacket(type, pin, value, ebuNum, buffer);
...
void bucketUp(int voltage, char buffer[]){
	//	char type ="A";
...
void bucketDown(int voltage, char buffer[]){
	//	char type ="A";
	//	uint8_t pin = 12;
	int ebuNum = 1;
	//enQueuePacket(type, pin, value, ebuNum, buffer);
...
int main()
{
	...
	int err = pthread_create(&t1, NULL, handleInput, NULL);

	if (err){
		perror("Something went wrong with the thread");
	}
	printf("Thread created, awaiting input");
